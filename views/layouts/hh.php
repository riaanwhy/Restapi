    ...
    echo Nav::widget([
        ...
        'items' => [
             if (!Yii::$app->user->isGuest  && $usr->st == 1){
                 ['label' => 'Profile', 'url' => ['nasabah/profile']],

                 ['label' => 'BangSampah', 'url' => ['nasabah/member']],

                 ['label' => 'Laporan', 'url' => ['transaksi-nasabah/index']],
             }elseif (!Yii::$app->user->isGuest  && $usr->st == 2) {
                 # code...
             ['label' => 'Lembaga', 'url' => ['lembaga/profile']],
